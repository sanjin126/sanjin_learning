...
import com.sanjin.service.impl.FruitServiceImpl;
...
public class FruitController extends ViewBaseServlet {
    ...
    private void index(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        session.setAttribute("pgCount", pageCount);
    ...
    private void add(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (Stringutils.isNotEmpty( fname, price, fcount, remark)){
            fruitService.addFruit(new Fruit(0, fname, Integer.parseInt(price),
    ...
    private void del(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (Stringutils.isNotEmpty(fid)){
            fruitService.delFruitById(Integer.parseInt(fid));
        }
        resp.sendRedirect(req.getContextPath()+"/index");
    }
    ...
    private void edit(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        String fid = req.getParameter("fid");
        if (Stringutils.isNotEmpty(fid)){
            Fruit fruit = fruitService.getFruitById(Integer.parseInt(fid));
    ...
    private void update(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (Stringutils.isNotEmpty(fid, fname, price, fcount, remark)){
            fruitService.updateFruit(new Fruit(Integer.parseInt(fid), fname, Integer.parseInt(price),
                    Integer.parseInt(fcount), remark));
        }
        resp.sendRedirect(req.getContextPath()+"/index");
